...
urlpatterns = [
    ...
    path("auth/captcha/", CaptchaApi.as_view(), name="auth-captcha"),
    ...
    path("auth/github/start/", GitHubOAuthStartApi.as_view(), name="auth-github-start"),
    path("auth/github/callback/", GitHubOAuthCallbackApi.as_view(), name="auth-github-callback"),
